...
public class SQRExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(SQRDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new SQRStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static SQRDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static SQRDateTimeConverter dateTimeConverter = new SQRStandardDateTimeConverter();

    public SQRExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public SQRExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new SQRMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=SQRHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,SQRExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=SQRHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
