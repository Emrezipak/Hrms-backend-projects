...
public class SQRKPSPublicSoap
{
    ...
    public SQRKPSPublicSoap(){}

    public SQRKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public SQRKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        SQRExtendedSoapSerializationEnvelope envelope= new SQRExtendedSoapSerializationEnvelope(SQRExtendedSoapSerializationEnvelope.VER11);
