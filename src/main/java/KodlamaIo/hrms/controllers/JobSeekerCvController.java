...
public class JobSeekerCvController {
    ...
    public Result updateCv(@RequestBody @Valid CvRequest cvRequest,
    ...
    public Result getByIdCv(@RequestParam long id, @RequestParam String identificationNo) {
    ...
    public Result getAllCvByUserId(@RequestParam(name = "userId") Long id) {
